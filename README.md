...
|<a name="cn3y-1738742770213"></a>**大数据能力**|<a name="w7qu-1738742770216"></a>Redshift、Athena等丰富|<a name="0xek-1738742770219"></a>与Microsoft Power BI整合|<a name="8a7c-1738742770222"></a>BigQuery全球领先|<a name="gvg8-1738742770225"></a>适合国内大数据处理|
...
<a name="ea6m-1738742755271"></a>**阿里云**

<a name="sabv-1741341881554"></a><a name="c7ij-1741007598713"></a>**云计算基础**

<a name="uxaj-1741004702464"></a>**数据中心概述**
...
<a name="ml9a-1740760337967"></a>- 降低I/O 延时的是 (A本地SSD盘)

<a name="vbcj-1741004680442"></a>**弹性计算**

<a name="frlc-1741007624199"></a>**云服务器ECS**
...
` `-稳定状态(运行中)(已停止)，-可创建快照，-挂载云盘，格式化后挂载

` `中间状态(停止中)(创建中)(已过期)



` `- 只有已停止才能更换系统盘，和回滚快照-停止I/O操作





<a name="vcrv-1741155550812"></a>   

<a name="5xwu-1741154565567"></a><a name="sdgg-1741152524484"></a>**WordPress网站**
...
<a name="81yc-1741168384198"></a>**专有云**
...
<a name="n8wp-1741170373841"></a>而专有云，从物理硬件、网络、环境到IaaS、PaaS、SaaS都需要客户自己运维，因此专有云的运维难度明显大于公有云。

<a name="puwk-1741170363311"></a>**弹性伸缩服务ESS**
...
-伸缩组定义了组内可容纳实例数的最大最小值、关联负载均衡实例、(关联RDS实例)等属性
...
动态模式 -基于云监控（CPU使用率）报警任务，出发报警并执行指定规则
...
.需搭配其他云服务才能正常工作，不可单独增减ECS,需搭配ECS
...
<a name="z4tn-1741155731624"></a>-ESS说法正确的是（可以结合SLB）（可以结合RDS进行部署）

<a name="w2dg-1741155722171"></a><a name="oocn-1741007673392"></a>**容器服务**
...
<a name="yk3x-1741265616958"></a>-ACD版本 

<a name="swix-1741007727542"></a>**存储服务**

<a name="mh7k-1741004717913"></a>**云存储**
...
<a name="uob5-1741248056485"></a>-本地盘不支持远程挂载(本地)，也不可由云盘转本地盘

<a name="dvzl-1741155133629"></a><a name="cqe4-1741004754754"></a>**对象存储OSS**
...
<a name="ogfa-1741155823468"></a>-OSS错误的是（需要制作文件系统后才能释放）

<a name="7yxd-1741155826564"></a><a name="gbir-1741155829013"></a>**云数据库**

<a name="en4o-1741162090461"></a>**云数据库RDS**
...
<a name="2fhw-1741162098347"></a><a name="y5cs-1741007785706"></a>**云网络**
...
<a name="iihr-1741157508386"></a>(丢包率)(网络时延)(带宽)(抖动)

<a name="54ip-1741162549339"></a>**网络服务VPC**
...
<a name="r3sl-1741072400894"></a>- 经典网络 阿里云自动分配IP, EIP不可绑定

<a name="fpca-1741007811819"></a>** 

<a name="3ckp-1741155317826"></a> **负载均衡**
...
当前提供四层（TCP协议和UDP协议）-LVS

和七层（HTTP和HTTPS协议）的负载均衡服务 Tengin
...
SLB云负载均衡仅支持按量付费                                                                                                                         CLB支持按量计费和包年包月两种模式    
...
<a name="leog-1741168787096"></a>                                                                                                                                                                                                                                                                                                                                                                                                                                                                              -HAProxy 高并发(10000+) 一万+                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        

<a name="wf2f-1741007789014"></a>**CDN**

-内容分发网络作用

阿里云内容分发网络CDN支持阿里云服务以外的服务提供加速服务。
...
<a name="oreu-1741169444739"></a>**云上防护安全！**
...
.WAF - -插件漏洞，XSS跨站脚本JavaScript攻击  -敏感信息泄露  -挑战黑洞/cc攻击
...
<a name="dwsk-1741243797005"></a>默认HTTP

<a name="opp3-1741152928074"></a>**云计算安全**
...
<a name="vc5f-1741161305753"></a>（软件PUF非物理）

<a name="kifv-1741152938574"></a><a name="frug-1741004730289"></a>**云监控**
...
<a name="dogh-1741004675531"></a>**ACP试题**




<a name="flrb-1741004675682"></a><a name="f2dd-1741341163713"></a><a name="grgq-1741341163885"></a><a name="wjhe-1741341164062"></a><a name="dpwa-1738742755619"></a>**Google Cloud Platform主要服务**

![image.png](assets/Aspose.Words.7257fe32-60dc-4975-8bcb-882db6ce6a26.001.png)

<a name="g24a-1703958573661"></a><a name="lviv-1703958571950"></a>**图1.部署在Google Cloud上的典型多层Web应用。**

![image.png](assets/Aspose.Words.7257fe32-60dc-4975-8bcb-882db6ce6a26.002.png)

<a name="0pjd-1703960346839"></a><a name="un2p-1703960283871"></a>**图7.零信任微服务环境中的应用交付。**

![image.png](assets/Aspose.Words.7257fe32-60dc-4975-8bcb-882db6ce6a26.003.png)

<a name="hvhk-1703960929789"></a><a name="iclq-1703960284232"></a>**网格入站网关流量**

![image.png](assets/Aspose.Words.7257fe32-60dc-4975-8bcb-882db6ce6a26.004.png)
